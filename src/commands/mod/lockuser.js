  ...
  async execute(message, args) {
    ...
    try {
      ...
      await sendModLog(message.guild, {
        ...
        reason: `Bloqueado de enviar mensagens no canal ${message.channel}`
      });

    } catch (error) {
      console.error('[lockuser] Erro ao aplicar bloqueio:', error);
      return sendEmbed('yellow', message, 'Ocorreu um erro ao tentar bloquear o usuário neste canal.');
    }
  }
};
