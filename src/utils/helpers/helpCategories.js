...
module.exports = [
  ...
  // Sorteios
  {
    ...
    commands: [
      { name: 'sorteio', description: 'Inicia um novo sorteio.', usage: 'sorteio <prêmio> <vencedores> <tempo> [#canal]', permissions: ['ManageMessages'], details: 'Parâmetros: prêmio • vencedores • duração • canal (opcional)', id: '000000000000000029' },
