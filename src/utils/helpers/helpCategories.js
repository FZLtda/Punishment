...
module.exports = [
  ...
  // Sorteios
  {
    ...
    commands: [
      { name: 'sorteio', description: 'Inicia um novo sorteio.', usage: 'sorteio <prêmio> <vencedores> <tempo> [#canal]', permissions: ['ManageMessages'], details: 'Cria um sorteio definindo prêmio, quantidade de vencedores, duração e, opcionalmente, o canal.', id: '000000000000000029' },
